...
public class CelestialBody_Inspector : Editor
{
    ...
    private SerializedProperty customOrbitalProgress;
    ...
    private void OnEnable()
    {
        ...
        customOrbitalProgress = serializedObject.FindProperty("customOrbitalProgress");
    ...
    private void DrawCharacteristics()
    {
        using (new GUILayout.VerticalScope(EditorHelper.GetColoredStyle(EditorHelper.GroupBoxCol)))
        {
            ...
            EditorGUILayout.PropertyField(customOrbitalProgress);
