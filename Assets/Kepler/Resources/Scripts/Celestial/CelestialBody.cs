...
public class CelestialBody : MonoBehaviour
{
    ...
    [SerializeField]
    private float customOrbitalProgress = 0f;
    ...
    public void SetApoapsis(float apo)
    {
        this.apoapsis = apo;
    }

    public void SetPeriapsis(float peri)
    {
        this.periapsis = peri;
    }
    ...
    public void ScrubOrbit(float scrub)
    {
        ...
        if (customOrbitalProgress > 0f) {
            orbitalProgress = customOrbitalProgress;
        }
        else orbitalProgress = scrub * 365f;
